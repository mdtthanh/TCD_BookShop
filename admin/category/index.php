	...
	<div class="col-md-6">
		<form method="post" action="index.php" onsubmit="return validateForm();">
			<div class="form-group">
			  ...
			  <input required="true" type="text" class="form-control" id="usr" name="name" value="<?=$name?>" style=" border-radius: 10px">
...
<script type="text/javascript">
	function deleteCategory(id) {
		option = confirm('Are you sure you want to delete this book category?')
		if(!option) return;
